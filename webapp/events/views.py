# from lecturer.db import db
from flask import Blueprint, redirect, render_template
# from lecturer.lector.models import Lecturer
...
# @blueprint.route('/new-lector', methods=['POST','GET'])
# def new_lector():
...
#     return render_template("new-lector.html", title="Добавление лектора в базу")
