...
(function($) {
    ...
    function insertLegend(plot, options, placeholder, legendEntries) {
        ...
        for (i = 0; i < entries.length; ++i) {
            ...
            labelHtml = '<text x="' + shape.xPos + '" y="' + shape.yPos + '" text-anchor="start"><tspan dx="2em" dy="https://mannatthemes.com/dastone-1/plugins/flot-chart/1.2em">' + shape.label + '</tspan></text>'
        ...
        switch (name) {
            case 'circle':
                html = '<use xlink:href="#circle" class="legendIcon" ' +
                    ...
                    'stroke="' + stroke + '" ' +
                    'stroke-width="' + width + '" ' +
                    'width="https://mannatthemes.com/dastone-1/plugins/flot-chart/1.5em" height="https://mannatthemes.com/dastone-1/plugins/flot-chart/1.5em"' +
                    '/>';
                break;
            case 'diamond':
